<?php
	...
	$localidades = getlocalidades($conexao);
				...
				<div id="container-editar-musico" style="height: none;">
					<aside class="opcoes-painel">
						<ul id="ul-opcoes-painel">
							<li><a  href="painel-adm.php">Categorias</a></li>
							<li class="liSelecionado"><a  href="generos.php">Generos</a></li>
							<li><a class="aSelecionado" href="localidades.php">Localidades</a></li>
							<li><a href="logout.php">Logout</a></li>
						</ul>
					</aside>
					...
					<div id="caixa-de-entrada">
						<?php
							while($localidade = mysqli_fetch_assoc($localidades)){
								echo "<tr>";
								echo "<td>" . $localidade['id'] . " |</td>";
								echo "<td>" . utf8_encode($localidade['localidade']) . " |</td>";
								echo "<td> <a class='aSelecionado' href='editar-localidade.php?i=" . $localidade['id'] . "'> <strong>Editar</strong> </a></td>";
								echo "</tr><br>";
							}
						?>
