				...
				<div id="container-editar-musico" style="height: none;">
					<aside class="opcoes-painel">
						<ul id="ul-opcoes-painel">
							...
							<li class="liSelecionado"><a class="aSelecionado" href="generos.php">Generos</a></li>
					...
					<div id="caixa-de-entrada">
						<?php
							while($genero = mysqli_fetch_assoc($generos)){
								...
								echo "<td>" . $genero['nome_genero'] . " |</td>";
								echo "<td> <a class='aSelecionado' href='editar-genero.php?i=" . $genero['id_genero'] . "'> <strong>Editar</strong> </a></td>";
								echo "</tr><br>";
							}
						?>
